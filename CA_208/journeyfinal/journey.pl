/* 
   ...
   ID: 18482934
   Resources used:
   1) Dijkstras Algorithim Explained(Youtube) https://www.youtube.com/watch?v=gdmfOwyQlcI
   2) CA208 Prolog notes https://www.computing.dcu.ie/%7Edavids/courses/CA208/CA208_Prolog_2p.pdf
   3) General Prolog tutorial https://www.youtube.com/watch?v=SykxWpFwMGs&t=2014s
*/ 
...
/* 
  Speed of modes of transport used
*/
speed(f, 5).
speed(c, 80).
speed(t, 100).
